...
class MyCrossAttnProcessor:
    def __call__(self, attn: CrossAttention, hidden_states, encoder_hidden_states=None, attention_mask=None):
        ...
        query = attn.head_to_batch_dim(query)# reshape成(batch_size * head_size, seq_len, dim // head_size)
        ...
        attn.keys = key
        attn.query = query
        #print(attn.attn_probs.shape)
        #得到Atten_probs即为atten map
